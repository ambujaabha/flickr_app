...
from api.settings import flickr_api_key # This has to be imported as djnago.conf import settings, when working with two settings file for staging and prod
from api.settings import flickr_base_url
from photos.serializers import GroupSerializer
