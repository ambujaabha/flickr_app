...
class Group(models.Model):
    ...
    group_id = models.CharField(unique=True,max_length=20,primary_key=True,default=None)
    group_name = models.CharField(max_length=60)

class Photo(models.Model):
    id = models.CharField(primary_key=True,max_length=20,default=None)
    group = models.ForeignKey(Group,on_delete=models.CASCADE,default=None,related_name="photos")
    ...
    dateadded = models.CharField(max_length=20,default=None,null=True,blank=True)
